        ...
        <Card className="border border-slate-200 dark:border-white/10 bg-white/70 dark:bg-slate-900/35 backdrop-blur-2xl shadow-2xl p-3 rounded-3xl transition-all">
          <CardContent className="space-y-6 text-slate-600 dark:text-gray-300 text-sm leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <p>
                Creando un account o registrandoti su {brand.name} SSO, accetti di essere vincolato dai presenti Termini di Servizio. Se non accetti una qualsiasi delle clausole riportate, non puoi utilizzare la nostra piattaforma.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                {brand.name} fornisce un servizio di Single Sign-On (SSO) centralizzato che consente agli utenti registrati di accedere in modo sicuro alle proprie applicazioni dell&apos;ecosistema {brand.name}, differenziando gli account in base alla tipologia: Personal (B2C), Business (B2B), Government (B2G/PA) ed Education.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p>
                {brand.name} non potrà essere ritenuta responsabile per interruzioni temporanee del servizio, ritardi dovuti a sistemi di terze parti (come Stripe o VIES) o per qualsiasi perdita derivante da un uso non autorizzato del tuo account.
              </p>
            </section>
